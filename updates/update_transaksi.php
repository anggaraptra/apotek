...
?>
    ...
    <head>
        ...
        <title>MyApotek - Update Transaksi</title>
    ...
    <body>
        ...
        <main id="main" class="main">
            <div class="pagetitle">
                ...
                <nav>
                    <ol class="breadcrumb print">
                        ...
                        <li class="breadcrumb-item active"><a href="../dashboard.php?page=transaksi">Transaksi</a></li>
            ...
            <section class="section" id="updateTransaksi">
                <div class="container my-4">
                    <form action="../functions/update/proses_update_transaksi.php" method="POST" id="formUpdate">

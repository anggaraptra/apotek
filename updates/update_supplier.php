...
?>
    ...
    <head>
        ...
        <title>MyApotek - Update Supplier</title>
    ...
    <body>
            ...
            <ul class="sidebar-nav" id="sidebar-nav">
                ...
                <li class="nav-item">
                    ...
                    <ul id="tables-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
                        ...
                        <li>
                            <a class="active" href="../dashboard.php?page=supplier">
        ...
        <main id="main" class="main">
            <div class="pagetitle">
                ...
                <nav>
                    <ol class="breadcrumb print">
                        ...
                        <li class="breadcrumb-item active"><a href="../dashboard.php?page=supplier">Supplier</a></li>
            ...
            <section class="section" id="updateSupplier">
                <div class="container my-4">
                    <form action="../functions/update/proses_update_supplier.php" method="POST" id="formUpdate">

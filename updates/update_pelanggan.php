...
?>
    ...
    <head>
        ...
        <title>MyApotek - Update Pelanggan</title>
    ...
    <body>
            ...
            <ul class="sidebar-nav" id="sidebar-nav">
                ...
                <li class="nav-item">
                    ...
                    <ul id="tables-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
                        ...
                        <li>
                            <a class="active" href="../dashboard.php?page=pelanggan">
        ...
        <main id="main" class="main">
            <div class="pagetitle">
                ...
                <nav>
                    <ol class="breadcrumb print">
                        ...
                        <li class="breadcrumb-item active"><a href="../dashboard.php?page=pelanggan">Pelanggan</a></li>
            ...
            <section class="section" id="updatePelanggan">
                <div class="container my-4">
                    <form action="../functions/update/proses_update_pelanggan.php" method="POST" enctype="multipart/form-data" id="formUpdate">
                        <table border='0' collspacing='0' collpadding='0' cellpadding='2' cellspacing='0'>
                            ...
                            <tr>
                                <td>Foto Resep</td>
                                <td></td>
                                <td><img class="img-responsive rounded w-50" src="../assets/img/fotoresep/<?= $pelanggan['buktifotoresep'] ?>" alt=""></td>
                            </tr>
